...
document.getElementById('content').innerHTML = `<h1>Hey there!</h1><p>${teacher} thinks its funny.... its not</p><iframe src="https://maxw2.github.io/chrome_dino_js/" width="570px" height="180px" style="position:relative;left:-20%;"></iframe>`  
